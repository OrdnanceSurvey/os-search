...
// ---------- variables setup end -----------
var h=function(a,b){return c.Observable.create(function(c){try{var d=a.call(this,b);c.onNext(d)}catch(e){c.onError(e)}})},i=function(a,d){var e=a.url;angular.isFunction(a.url)&&(e=a.url(d));var f={params:angular.copy(a.params),data:angular.copy(a.data),dataType:a.dataType,url:e,method:a.method};
